...
<body>
    ...
    <header class="clearfix">
      ...
      <div style="text-align: center; float: left;" >
        <div style="font-size: 12">Thông tin khách hàng</div>
        <div>Họ tên khách hàng: {{$order->tenkh}}</div>
        <div>Số điện thoại: {{$order->sdt}}</div>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="unit"><center><?php echo number_format($orderDetail->giaban).' ' ?><u>đ</u></center></td>
            <td class="qty"><center>{{ $orderDetail->total_number }}</center></td>
            <td class="total"><center><?php echo number_format($orderDetail->giaban * $orderDetail->total_number).' ' ?><u>đ</u></center></td>
          </tr>
          @endforeach
          <tr>
            <td colspan="4">TỔNG TIỀN</td>
            <td class="total"><?php echo number_format($order->total_sales).' ' ?><u>đ</u></td>
          </tr>
          <tr>
            <td colspan="4">PHÍ SHIP</td>
            <td class="total"><?php echo number_format($order->phiship).' ' ?><u>đ</u></td>
          </tr>
          <tr>
            <td colspan="4" class="grand total">SỐ TIỀN CẦN THANH TOÁN</td>
            <td class="grand total"><?php echo number_format($order->total_sales + $order->phiship).' ' ?><u>đ</u></td>
          </tr>
        </tbody>
      </table>
    ...
    <footer>
      ...
      <div style="text-align: left; float: right">
        <div style=";font-size: 10;"><b>Người mua hàng<b></div>
      ...
      <div style="text-align: right;">
        <div style=";font-size: 10;"><b>Người giao hàng<b></div>
        <div style=";font-size: 8;">(Ký, ghi rõ họ tên)</div>
      </div></div>
    </footer>
    @endforeach
